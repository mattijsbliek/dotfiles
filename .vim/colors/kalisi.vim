...
if &background == "dark"
  ...
  hi Normal 	      guifg=#b5b5b5 guibg=#222222  gui=none
  ...
  hi SignColumn       guifg=#A6E22E guibg=#2C2C2C
  hi FoldColumn       guifg=#b0b8c0 guibg=#373d43 gui=bold
  hi Folded 	      guifg=#727780 guibg=#373d43 gui=none

  hi NonText          guifg=#958b7f guibg=#222222 gui=none
  hi Conceal          guifg=#f6f3e8 guibg=#303030

  hi LineNr 	      guifg=#857b6f guibg=#2C2C2C gui=none

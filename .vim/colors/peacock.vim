...
" Custom tweaks by Mattijs Bliek

" Set CursorLine highlight here since theme doesn't have one
hi CursorLine  term=underline  guibg=#333333  cterm=underline

" Set color column color
hi ColorColumn guibg=#444444 ctermbg=0

let g:colors_name = "Peacock"
let colors_name   = "Peacock"

" Highlight color for omni menu
hi Pmenu guibg=#111 gui=bold
